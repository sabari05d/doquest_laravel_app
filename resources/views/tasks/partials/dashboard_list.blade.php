@if(isset($sectionTitle))
    <h5 class="mt-4 mb-3 fw-semibold">{{ $sectionTitle }}</h5>
@endif

@forelse($tasks as $date => $dayTasks)
    <div class="timeline-date mb-2 mt-3 text-start text-muted">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-danger" href="javascript:void(0)"
                                            onclick="deleteTask('{{ route('deleteTask', $task->id) }}')">
                                            Delete
                                        </a>
                                    </li>
                                </ul>
    ...
    @endif
@empty
    <p class="p-2 text-muted">No tasks found.</p>
@endforelse